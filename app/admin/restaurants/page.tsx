...
export default async function RestaurantsPage() {
  ...
  return <Shell>
    <div className="mb-6">
      ...
      <p className="mt-2 text-slate-600">Create, switch, export, deactivate, and manage restaurant workspaces. New restaurants start with generic BBQ production assumptions that can be tuned during setup.</p><div className="mt-4 flex flex-wrap gap-2"><a href="/admin/restaurants/setup" className="btn-secondary inline-flex">Open Setup Wizard</a><a href="/admin/restaurants/pos" className="btn-secondary inline-flex">POS / Sales Import</a><a href="/api/admin/tenant/export" className="btn-secondary inline-flex">Export Active Tenant</a></div>
    </div>
    ...
    <section className="mt-6 card p-5">
      ...
      <p className="mt-2 text-sm text-slate-600">Before canceling or deleting a restaurant, export the tenant JSON. Deactivation preserves a safety window for restore.</p>
