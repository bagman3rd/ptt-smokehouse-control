...
export default async function RestaurantsPage() {
  ...
  return <Shell>
    ...
    <section className="mt-6 card p-5">
      ...
      <p className="mt-2 text-sm text-slate-600">Before canceling or deleting a restaurant, export the tenant JSON. Build 3.4.0 soft-deletes tenant access instead of hard-deleting rows so there is a safety window for restore.</p>
