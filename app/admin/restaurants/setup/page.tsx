...
export default async function RestaurantSetupWizardPage() {
  ...
  return <Shell>
    <div className="mb-6">
      ...
      <p className="mt-2 text-slate-600">{restaurant.name} · Build 3.6.0 adds self-service setup, generic BBQ defaults, sales-history import, and audit-backed onboarding. Each save writes tenant-scoped settings and audit entries.</p>
    </div>
