...
export default async function PosImportPage({searchParams}:{searchParams?:Record<string,string|undefined>}) {
  ...
  return <Shell>
    ...
    <section className="card p-5"><h2 className="text-xl font-black">Live Connections</h2><p className="mt-2 text-sm text-slate-600">Square is enabled in Build 11.0.1. The other provider adapters share the same data model and will be activated in later 8.x builds after partner access is available.</p>
