...
export default async function PosImportPage() {
  ...
  return <Shell>
    <div className="mb-6">
      ...
      <p className="mt-2 text-slate-600">{restaurant.name} · Build 3.8.1 adds a first POS-ready CSV path. Toast API should come later; this closes the first onboarding friction point without locking us to one POS vendor.</p>
    </div>
