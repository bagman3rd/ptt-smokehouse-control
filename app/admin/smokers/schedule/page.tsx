  ...
  return <Shell>
    <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <p className="mt-2 text-slate-600">Build 5.1.0 production-constraint view: assign planned protein loads to active smokers and surface capacity conflicts before service.</p>
      </div>
