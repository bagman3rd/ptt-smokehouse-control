...
export default async function BillingPage() {
  ...
  return <Shell>
    <div className="mb-6"><h1 className="text-3xl font-black tracking-tight">Billing</h1><p className="mt-2 text-slate-600">Build 4.4.0 adds a lightweight Stripe-payment-link path for trial/subscription onboarding. Use Stripe-hosted checkout until full API billing is needed.</p></div>
