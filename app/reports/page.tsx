...
export default async function ReportsPage({ searchParams }: { searchParams: Record<string, string | string[] | undefined> }) {
  ...
  return <Shell>
    <div className="mb-6">
      ...
      <p className="mt-2 text-slate-600">Saved operating history is reportable by date, day of week, protein, and source data. {restaurant.name} · Build 3.5.0 adds self-service onboarding, demo data, report exports, and commercial-readiness controls.</p>
    </div>
