  ...
  return <main className="min-h-screen bg-slate-50 px-4 py-10">
    <div className="mx-auto max-w-2xl rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-200">
      <div className="mb-6">
        ...
        <p className="mt-2 text-slate-600">Build 4.3.3 adds self-service signup with sensible generic BBQ defaults. Pigeon Forge/PTT assumptions are no longer forced onto new restaurants.</p>
      </div>
