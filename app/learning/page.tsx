...
export default async function LearningPage() {
  ...
  return <Shell>
    <div className="mb-6">
      ...
      <p className="mt-2 text-slate-600">Build 3.8.0 applies accepted recommendations safely: preview before/after, enforce sample-size rules, audit the setting change, and keep rollback available.</p>
    </div>
