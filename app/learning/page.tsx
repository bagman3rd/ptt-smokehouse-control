...
export default async function LearningPage() {
  ...
  return <Shell>
    <div className="mb-6">
      ...
      <p className="mt-2 text-slate-600">Build 4.6.0 adds visible trailing-30-day forecast accuracy proof points while keeping accepted learning changes controlled: preview before/after, enforce sample-size rules, audit the setting change, and keep rollback available.</p>
    </div>
