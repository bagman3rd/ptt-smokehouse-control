export default function PrivacyPage() {
  return <main className="mx-auto max-w-4xl px-4 py-10">
    ...
    <p className="mt-3 text-slate-600">Build 4.7.0 starter privacy policy for pilot/commercial review. Have local counsel review before selling to unrelated restaurants.</p>
