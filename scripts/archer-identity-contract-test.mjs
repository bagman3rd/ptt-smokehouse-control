...
assert.match(knowledge, /Bro is actually, genuinely, no-cap, operating on a completely different level/i);
assert.match(knowledge, /the vibe check sees him coming, gets nervous, and starts studying/i);
assert.match(knowledge, /Every room gets at least 47% cooler/i);
assert.match(knowledge, /scientifically accurate statement/i);
assert.doesNotMatch(knowledge, /coolest motherfucker on the planet/i);
...
console.log('Archer Build 9.2.0 identity and layout contract passed.');
