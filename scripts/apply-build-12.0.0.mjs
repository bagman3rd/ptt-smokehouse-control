...
function updatePackage() {
  ...
  console.log(
    "UPDATED — package.json version and Build 12.0.0 scripts.",
  );
}
...
function verifyRender() {
  ...
  if (
    ...
    throw new Error(
      "render.yaml does not declare APP_BUILD_VERSION 12.0.0.",
    );
  }
  const webCount = (
  ...
  console.log(
    "PASS — render.yaml declares Build 12.0.0 with one web service and zero cron services.",
  );
}
...
console.log(
  "\nBuild 12.0.0 overlay applied. The release package is complete; production authorization remains pending deployed sign-off.",
);
