...
function updatePackage() {
  ...
  data.scripts["today:workbench"] =
    "node scripts/generate-today-workbench-11.5.0.mjs";
  ...
  data.scripts["build:11.5.0"] =
    "node scripts/apply-build-11.5.0.mjs";
  fs.writeFileSync(
    packagePath,
  ...
  console.log(
    "UPDATED — package.json version and Build 11.5.0 scripts.",
  );
}
...
function verifyRender() {
  ...
  if (
    ...
    throw new Error(
      "render.yaml does not declare APP_BUILD_VERSION 11.5.0.",
    );
  }
  console.log("PASS — render.yaml declares Build 11.5.0.");
}
...
console.log(
  "\nBuild 11.5.0 overlay applied, Today Operations Lab generated, and operating-day evidence produced.",
);
