...
assert.ok(fs.existsSync(migrationPath), 'Build 7.8.4 EOD numeric type repair migration is missing');
...
console.log('Build 7.8.4 EOD database column type contract passed.');
