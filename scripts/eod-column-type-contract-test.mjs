...
assert.ok(fs.existsSync(migrationPath), 'Build 7.9.0 EOD numeric type repair migration is missing');
...
console.log('Build 7.9.0 EOD database column type contract passed.');
