...
assert.ok(fs.existsSync(migrationPath), 'Build 8.0.1 EOD numeric type repair migration is missing');
...
console.log('Build 8.0.1 EOD database column type contract passed.');
