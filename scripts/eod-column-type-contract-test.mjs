...
assert.ok(fs.existsSync(migrationPath), 'Build 9.2.0 EOD numeric type repair migration is missing');
...
console.log('Build 9.2.0 EOD database column type contract passed.');
