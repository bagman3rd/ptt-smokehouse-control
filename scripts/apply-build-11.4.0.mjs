...
function updatePackage() {
  ...
  data.scripts["production:test"] = "node scripts/test-production-planning-11.4.0.mjs";
  data.scripts["production:workbench"] = "node scripts/generate-production-workbench-11.4.0.mjs";
  data.scripts["production:evidence"] = "node scripts/production-control-plane-11.4.0.mjs";
  data.scripts["production:verify"] = "node scripts/verify-production-planning-11.4.0.mjs";
  data.scripts["build:11.4.0"] = "node scripts/apply-build-11.4.0.mjs";
  fs.writeFileSync(packagePath, `${JSON.stringify(data, null, 2)}\n`, "utf8");
  console.log("UPDATED — package.json version and Build 11.4.0 scripts.");
}
...
function verifyRender() {
  ...
  if (!/key:\s*APP_BUILD_VERSION\s*\n\s*value:\s*"11\.4\.0"/m.test(render)) {
    throw new Error("render.yaml does not declare APP_BUILD_VERSION 11.4.0.");
  }
  console.log("PASS — render.yaml declares Build 11.4.0.");
}
...
console.log("\nBuild 11.4.0 overlay applied, Production Planning Lab generated, and production evidence produced.");
