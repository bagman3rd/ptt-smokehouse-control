...
const cook=read('app/api/cook-plan/route.ts');
if (!cook.includes('Math.max(prior.usableLeftoverUnits') || !cook.includes('prior.sealedUnopenedUnits')) throw new Error('Legacy sealed EOD credit fallback missing.');
