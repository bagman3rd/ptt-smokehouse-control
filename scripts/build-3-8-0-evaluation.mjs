...
assert(pkg.version === '3.8.0', 'package version must be 3.8.0');
assert(pkg.scripts['build:eval'].includes('build-3-8-0-evaluation'), 'build:eval must use Build 3.8.0 evaluation script');
...
assert(nav.includes('Build 3.8.0'), 'Nav badge not updated');
...
console.log('Build 3.8.0 evaluation checks completed.');
