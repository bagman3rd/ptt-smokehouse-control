...
assert(pkg.version === '5.8.0', 'package version must be 5.8.0');
assert(read('components/Nav.tsx').includes('Build 5.8.0'), 'nav must show Build 5.8.0');
...
console.log('Build 5.8.0 evaluation checks completed.');
