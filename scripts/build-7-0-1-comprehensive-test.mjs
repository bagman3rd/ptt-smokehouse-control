...
assert.ok(api.includes("proteinCode === 'PORK' || proteinCode === 'CHICKEN' || proteinCode === 'RIBS'"), 'carryover rule missing');
...
console.log('Build 7.2.2 comprehensive static acceptance checks passed.');
