...
assert(existsSync('MIGRATION_REPAIR_RUNBOOK_BUILD_4_2_0.md'), 'migration repair runbook should exist');
assert(existsSync('PILOT_READINESS_BUILD_4_2_0.md'), 'pilot readiness notes should exist');
