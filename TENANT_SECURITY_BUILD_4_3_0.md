# Build 4.3.0 Tenant + Security Hardening Notes

## Multi-tenant enforcement

Build 4.3.0 adds `lib/tenantGuard.ts`, a Prisma client extension wired through `lib/prisma.ts`.
...
Build 4.3.0 adds the `RateLimitBucket` table and rewrites the rate limiter to use Postgres upserts. This survives restarts and is safe if the Render service is later scaled to more than one instance.
