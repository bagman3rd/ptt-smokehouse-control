# Build 6.0.1 — CI Reliability Fix

Build 6.0.1 corrects the GitHub Actions packaging defect in Build 6.0.0.

## Fixes

- Includes `.github/workflows/ci.yml` in the downloadable project.
- Replaces the stale Build 5.9.3 workflow with **Build 6.0.1 CI**.
...
- Runs typecheck, lint, regression tests, Build 6.0.1 evaluation, and the production Next.js build.
