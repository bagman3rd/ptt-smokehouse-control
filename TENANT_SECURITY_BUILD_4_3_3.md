# Build 4.3.3 Tenant + Security Notes

Build 4.3.3 keeps the Build 4.3 tenant/security functionality and fixes a TypeScript deploy error in the Data Quality module.
