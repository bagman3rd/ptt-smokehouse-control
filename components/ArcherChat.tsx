...
export function ArcherChat() {
  ...
  return <div className="archer-root no-print" data-testid="archer-chat">
    {open ? <section className="archer-panel" role="dialog" aria-label="Archer support assistant">
      ...
      <div className="archer-portrait"><img src="/archer-bbq.jpg" alt="Archer wearing pitmaster gear"/></div>
    </section> : null}
