...
export async function createDefaultRestaurantData(prisma: any, restaurantId: string, profile: StarterProfile = 'generic') {
  const proteins = [
    { name: 'Brisket', code: 'BRISKET', inputUnit: ProteinUnit.EACH, rawWeightEachLb: 13, cookedWeightEachLb: 6.5, cookedYieldPercent: 50, avgSalesPerCookedLb: 38, purchaseCostEach: 0, salesPriceEach: 0, sandwichOz: 5, plateOz: 7, minCookUnits: 1, maxCookUnits: 80, reusableLeftover: true, maxReuseHours: 24, updatedBy: 'Self-Service Setup' },
    { name: 'Pulled Pork', code: 'PORK', inputUnit: ProteinUnit.EACH, rawWeightEachLb: 9, cookedWeightEachLb: 4.95, cookedYieldPercent: 55, avgSalesPerCookedLb: 21, purchaseCostEach: 0, salesPriceEach: 0, sandwichOz: 5, plateOz: 7, minCookUnits: 2, maxCookUnits: 84, reusableLeftover: true, maxReuseHours: 36, updatedBy: 'Self-Service Setup' },
    { name: 'Ribs', code: 'RIBS', inputUnit: ProteinUnit.RACK, rawWeightEachLb: 3.3, cookedWeightEachLb: 3.0, cookedYieldPercent: 90.9, avgSalesPerCookedLb: 11, purchaseCostEach: 10, salesPriceEach: 33, sandwichOz: 0, plateOz: 0, minCookUnits: 4, maxCookUnits: 200, reusableLeftover: true, maxReuseHours: 24, updatedBy: 'Self-Service Setup' },
    { name: 'Pulled Chicken', code: 'CHICKEN', inputUnit: ProteinUnit.EACH, rawWeightEachLb: 2.5, cookedWeightEachLb: 1.875, cookedYieldPercent: 75, avgSalesPerCookedLb: 20, purchaseCostEach: 0, salesPriceEach: 0, sandwichOz: 5, plateOz: 7, minCookUnits: 6, maxCookUnits: 180, reusableLeftover: true, maxReuseHours: 36, updatedBy: 'Self-Service Setup' }
  ];
