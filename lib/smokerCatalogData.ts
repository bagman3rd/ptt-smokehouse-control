...
// 2) Manufacturer-published pork butt, brisket, rib, and whole-chicken counts are valid planning counts.
// 3) For this project, one published whole chicken equals one chicken / double-breast planning unit. Do not double it.
// 4) Published pound capacities, ranges, and half-chicken counts stay in officialCapacityText and are not auto-loaded as unit counts.
export const smokerCatalogSeeds: SmokerCatalogSeed[] = [
  // Ole Hickory Pits. Brisket, butt, rib, and whole-chicken counts are official count capacities. Whole-chicken count loads 1:1 as chicken / double-breast planning units.
  row({ brand:'Ole Hickory Pits', model:'EL-ED/X', series:'EL', smokerType:'Rotisserie', fuelType:'Gas + wood', rackCount:12, rackWidthIn:18, rackDepthIn:48, cookingAreaSqIn:10368, brisketCapacity:40, porkCapacity:80, ribCapacity:105, chickenCapacity:72, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'40 briskets; 80 Boston butts; 105 ribs; 72 whole chickens', sourceUrl:OLE+'el-edx', sourceLabel:'Ole Hickory EL-ED/X product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'EL-ED', series:'EL', smokerType:'Rotisserie', fuelType:'Gas + wood', rackCount:18, rackWidthIn:12, rackDepthIn:48, cookingAreaSqIn:10368, brisketCapacity:40, porkCapacity:80, ribCapacity:105, chickenCapacity:72, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'40 briskets; 80 Boston butts; 105 ribs; 72 whole chickens', sourceUrl:OLE+'el-ed', sourceLabel:'Ole Hickory EL-ED product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'EL-EC', series:'EL', smokerType:'Rotisserie', fuelType:'Gas + wood', brisketCapacity:12, porkCapacity:30, ribCapacity:30, chickenCapacity:32, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'12 briskets; 30 Boston butts; 30 ribs; 32 whole chickens', sourceUrl:OLE+'el-ec', sourceLabel:'Ole Hickory EL-EC product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'EL', series:'EL', smokerType:'Rotisserie', fuelType:'Gas + wood', brisketCapacity:20, porkCapacity:40, ribCapacity:60, chickenCapacity:50, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'20 briskets; 40 Boston butts; 60 ribs; 50 whole chickens', sourceUrl:OLE+'el', sourceLabel:'Ole Hickory EL product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'EL-IB', series:'EL', smokerType:'Rotisserie', fuelType:'Gas + wood', brisketCapacity:20, porkCapacity:40, ribCapacity:60, chickenCapacity:60, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'20 briskets; 40 Boston butts; 60 ribs; 60 whole chickens', sourceUrl:OLE+'el-ib', sourceLabel:'Ole Hickory EL-IB product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'EL-EW', series:'EL', smokerType:'Rotisserie', fuelType:'Gas + wood', brisketCapacity:20, porkCapacity:50, ribCapacity:60, chickenCapacity:70, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'20 briskets; 50 Boston butts; 60 ribs; 70 whole chickens', sourceUrl:OLE+'el-ew', sourceLabel:'Ole Hickory EL-EW product page', sourceConfidence:'OFFICIAL' }),
  ...
  row({ brand:'Ole Hickory Pits', model:'SSE', series:'SS', smokerType:'Rotisserie', fuelType:'Gas + wood', brisketCapacity:30, porkCapacity:60, ribCapacity:90, chickenCapacity:90, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'30 briskets; 60 Boston butts; 90 ribs; 90 whole chickens', sourceUrl:OLE+'sse', sourceLabel:'Ole Hickory SSE product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'SSJ-AE', series:'SSJ', smokerType:'Large rotisserie', fuelType:'Gas + wood', brisketCapacity:60, porkCapacity:120, ribCapacity:150, chickenCapacity:105, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'60 briskets; 120 Boston butts; 150 ribs; 105 whole chickens', sourceUrl:OLE+'ssj-ae', sourceLabel:'Ole Hickory SSJ-AE product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'SSJ', series:'SSJ', smokerType:'Large rotisserie', fuelType:'Gas + wood', brisketCapacity:74, porkCapacity:150, ribCapacity:175, chickenCapacity:120, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'74 briskets; 150 Boston butts; 175 ribs; 120 whole chickens', sourceUrl:OLE+'ssj', sourceLabel:'Ole Hickory SSJ product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'CTO', series:'CTO', smokerType:'Cabinet', fuelType:'Gas + wood', brisketCapacity:12, porkCapacity:24, ribCapacity:24, chickenCapacity:48, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'12 briskets; 24 Boston butts; 24 ribs; 48 whole chickens', sourceUrl:OLE+'cto', sourceLabel:'Ole Hickory CTO product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'CTO-DW', series:'CTO', smokerType:'Cabinet', fuelType:'Gas + wood', cookingAreaSqIn:5760, brisketCapacity:30, porkCapacity:60, ribCapacity:48, chickenCapacity:96, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'30 briskets; 60 Boston butts; 48 ribs; 96 whole chickens', sourceUrl:OLE+'cto-dw', sourceLabel:'Ole Hickory CTO-DW product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'CTO-TQ', series:'CTO', smokerType:'Cabinet', fuelType:'Gas + wood', brisketCapacity:9, porkCapacity:18, ribCapacity:18, chickenCapacity:36, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'9 briskets; 18 Boston butts; 18 ribs; 36 whole chickens', sourceUrl:OLE+'cto-tq', sourceLabel:'Ole Hickory CTO-TQ product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'ACE-BP', series:'ACE', smokerType:'Cabinet', fuelType:'Gas + wood', brisketCapacity:9, porkCapacity:18, ribCapacity:18, chickenCapacity:36, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'9 briskets; 18 Boston butts; 18 ribs; 36 whole chickens', sourceUrl:OLE+'ace-bp', sourceLabel:'Ole Hickory ACE-BP product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'ACE-JW', series:'ACE', smokerType:'Cabinet', fuelType:'Gas + wood', brisketCapacity:4, porkCapacity:12, ribCapacity:18, chickenCapacity:18, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'4 briskets; 12 Boston butts; 18 ribs; 18 whole chickens', sourceUrl:OLE+'ace-jw', sourceLabel:'Ole Hickory ACE-JW product page', sourceConfidence:'OFFICIAL' }),
  row({ brand:'Ole Hickory Pits', model:'Ultra Que', series:'Small cabinet', smokerType:'Cabinet', fuelType:'Gas + wood', brisketCapacity:4, porkCapacity:12, ribCapacity:18, chickenCapacity:18, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'4 briskets; 12 Boston butts; 18 ribs; 18 whole chickens', sourceUrl:OLE+'ultra-que', sourceLabel:'Ole Hickory Ultra Que product page', sourceConfidence:'OFFICIAL' }),

  // Southern Pride. Chicken is published as whole chickens where available and remains official text only.
  row({ brand:'Southern Pride', model:'SC-100', series:'SC', smokerType:'Cabinet', fuelType:'Gas + wood', brisketCapacity:4, porkCapacity:12, ribCapacity:12, chickenCapacity:24, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'4 briskets; 12 pork butts; 12 St. Louis ribs; 24 whole chickens', sourceUrl:SOUTHERN+'sc-100', sourceLabel:'Southern Pride SC-100 product page', sourceConfidence:'OFFICIAL' }),
  ...
  row({ brand:'Southern Pride', model:'SPK-500', series:'SPK', smokerType:'Mobile / fixed rotisserie', fuelType:'Gas + wood', rackCount:15, brisketCapacity:20, porkCapacity:60, ribCapacity:60, chickenCapacity:70, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'15 racks; 20 briskets; 60 pork butts; 60 St. Louis ribs; 70 whole chickens', sourceUrl:SOUTHERN+'spk-500', sourceLabel:'Southern Pride SPK-500 product page', sourceConfidence:'OFFICIAL' }),
  ...
  row({ brand:'Southern Pride', model:'SRG-800', series:'SRG', smokerType:'Rotisserie', fuelType:'Gas + wood', brisketCapacity:24, porkCapacity:72, ribCapacity:60, chickenCapacity:96, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'24 briskets; 72 pork butts; 60 St. Louis ribs; 96 whole chickens', sourceUrl:SOUTHERN+'srg-800', sourceLabel:'Southern Pride SRG-800 product page', sourceConfidence:'OFFICIAL' }),
  ...
  // Cookshack. Published capacities are pounds/load and whole chickens, not unit counts used by the production planner.
  row({ brand:'Cookshack', model:'SM160', series:'SmartSmoker', smokerType:'Electric cabinet', fuelType:'Electric + wood chunks', rackCount:5, rackWidthIn:18, rackDepthIn:18, cookingAreaSqIn:1620, brisketCapacity:null, brisketCapacityUnit:'LB', porkCapacity:null, porkCapacityUnit:'LB', ribCapacity:null, ribCapacityUnit:'LB', chickenCapacity:20, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'120 lb pork butts; 100 lb brisket; 50 lb ribs; 20 whole chickens', sourceUrl:COOKSHACK+'smoker-oven-model-160-stainless-steel.html', sourceLabel:'Cookshack SM160 product page', sourceConfidence:'OFFICIAL_PARTIAL' }),
  row({ brand:'Cookshack', model:'SM260', series:'SmartSmoker', smokerType:'Electric cabinet', fuelType:'Electric + wood chunks', rackCount:6, brisketCapacity:null, brisketCapacityUnit:'LB', porkCapacity:null, porkCapacityUnit:'LB', ribCapacity:null, ribCapacityUnit:'LB', chickenCapacity:40, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'240 lb pork butts; 200 lb brisket; 100 lb ribs; 40 whole chickens', sourceUrl:COOKSHACK+'smoker-oven-model-260-stainless-steel.html', sourceLabel:'Cookshack SM260 product page', sourceConfidence:'OFFICIAL_PARTIAL' }),
  row({ brand:'Cookshack', model:'SM360', series:'SmartSmoker', smokerType:'Electric cabinet', fuelType:'Electric + wood chunks', rackCount:28, brisketCapacity:null, brisketCapacityUnit:'LB', porkCapacity:null, porkCapacityUnit:'LB', ribCapacity:null, ribCapacityUnit:'LB', chickenCapacity:100, chickenCapacityUnit:'WHOLE_CHICKEN_COUNT', officialCapacityText:'550 lb pork butts; 500 lb brisket; 270 lb ribs; 100 whole chickens', sourceUrl:COOKSHACK+'smoker-oven-model-360-stainless-steel.html', sourceLabel:'Cookshack SM360 product page', sourceConfidence:'OFFICIAL_PARTIAL' }),
