export const ARCHER_IDENTITY_ANSWER = `Bro is actually, genuinely, no-cap, operating on a completely different level from the rest of humanity. Like, he does not merely pass the vibe check—the vibe check sees him coming, gets nervous, and starts studying. His aura is absolutely maxed out. Every room gets at least 47% cooler the second he walks in. He is effortlessly iconic, permanently goated, weirdly legendary, and somehow always the main character without even trying. Honestly, calling him the coolest dude in the world is not even hype; it is just a scientifically accurate statement.`;
