...
CREATE UNIQUE INDEX "PosConnection_restaurantId_provider_externalLocationId_key" ON "PosConnection"("restaurantId","provider","externalLocationId");
CREATE INDEX "PosConnection_restaurantId_status_idx" ON "PosConnection"("restaurantId","status");
CREATE INDEX "PosConnection_automaticSyncEnabled_status_lastSuccessfulSyncAt_idx" ON "PosConnection"("automaticSyncEnabled","status","lastSuccessfulSyncAt");
CREATE INDEX "PosSyncRun_restaurantId_createdAt_idx" ON "PosSyncRun"("restaurantId","createdAt");
CREATE INDEX "PosSyncRun_connectionId_status_createdAt_idx" ON "PosSyncRun"("connectionId","status","createdAt");
CREATE UNIQUE INDEX "PosRawRecord_connectionId_recordType_externalRecordId_key" ON "PosRawRecord"("connectionId","recordType","externalRecordId");
CREATE INDEX "PosRawRecord_restaurantId_businessDate_idx" ON "PosRawRecord"("restaurantId","businessDate");
CREATE INDEX "PosRawRecord_connectionId_processedAt_idx" ON "PosRawRecord"("connectionId","processedAt");
CREATE UNIQUE INDEX "PosMenuItem_connectionId_externalItemId_key" ON "PosMenuItem"("connectionId","externalItemId");
CREATE INDEX "PosMenuItem_restaurantId_active_idx" ON "PosMenuItem"("restaurantId","active");
CREATE INDEX "PosMenuItem_restaurantId_normalizedName_idx" ON "PosMenuItem"("restaurantId","normalizedName");
CREATE UNIQUE INDEX "PosOrder_connectionId_externalOrderId_key" ON "PosOrder"("connectionId","externalOrderId");
CREATE INDEX "PosOrder_restaurantId_businessDate_idx" ON "PosOrder"("restaurantId","businessDate");
CREATE INDEX "PosOrder_connectionId_rawUpdatedAt_idx" ON "PosOrder"("connectionId","rawUpdatedAt");
CREATE UNIQUE INDEX "PosLineItem_orderId_externalLineItemId_key" ON "PosLineItem"("orderId","externalLineItemId");
CREATE INDEX "PosLineItem_restaurantId_createdAt_idx" ON "PosLineItem"("restaurantId","createdAt");
CREATE INDEX "PosLineItem_restaurantId_externalItemId_idx" ON "PosLineItem"("restaurantId","externalItemId");
CREATE UNIQUE INDEX "PosWebhookEvent_connectionId_externalEventId_key" ON "PosWebhookEvent"("connectionId","externalEventId");
CREATE INDEX "PosWebhookEvent_restaurantId_receivedAt_idx" ON "PosWebhookEvent"("restaurantId","receivedAt");
CREATE INDEX "PosWebhookEvent_connectionId_processedAt_idx" ON "PosWebhookEvent"("connectionId","processedAt");
