# Pilot Readiness — Build 4.1.0

Build 4.1.0 is intended to close the biggest remaining pilot risk: database migration integrity.
...
- Build 4.1.0 deploys to production with `prisma migrate deploy`.
