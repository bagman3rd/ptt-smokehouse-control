# Build 11.0.0 Release Gate

A production ZIP may be generated only by `.github/workflows/release.yml` after the exact commit completes the mandatory **Build 11.0.0 CI** workflow successfully.
