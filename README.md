# PTT Smokehouse Control — Build 7.5.1

Build 7.5.1 is a full recovery release rebuilt from the last clean application baseline, Build 7.0.1.

## Build 7.5.1 navigation reliability fix
...
Replace the repository contents with the complete extracted Build 7.5.1 tree. Do not merge only selected files into an older working directory. Commit deletions as well as additions so stale files cannot remain in GitHub.
