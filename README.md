# PTT Smokehouse Control — Build 2.6.0

Private BBQ production-control app for Pigeon Toed Tavern. Build 2.6.0 is an authentication-hardening and operational-safety release on top of the reporting, learning, CSV export, and backup features added in Builds 2.3.0–2.5.0.
...
Build 2.6.0 closes the worst private-MVP auth gaps, but the app still needs these before selling externally:
