# Smokehouse Control — Build 6.0.0

Build 6.0.0 is a user-interface repair build layered on top of the 5.9.1 migration/CI repair.
...
```text
Build 6.0.0 navigation dropdown and smoker form labels
```
